...
const HeroSection = () => {
  ...
  href="/update/pos.zip"
  download
  className="block text-center w-full px-6 py-3 text-lg font-semibold rounded bg-light-accent dark:bg-dark-accent text-light-text dark:text-dark-text hover:opacity-90 transition-opacity"
>
  دانلود دمو
</a>
        </div>
